    ...
    def __sub__(self, p):
        ...
        if SHOW_SUBTRACTBUG_WARNING and p1 is not p3:
            ...
            try:
                ...
                print("+" * 79)
                print(
                    "Note that previous versions of pypoints contained a "
...
class Pointset(BasePoints):
    ...
    def __repr__(self):
        ...
        return "<pointset with %i points of %i dimensions>" % (len(self), self.ndim)
...
class Aarray(np.ndarray):
    ...
    origin = property(
        _get_origin, _set_origin, None, "A tuple with the origin for each dimension."
    )
