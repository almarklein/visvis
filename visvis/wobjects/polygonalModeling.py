...
class BaseMesh(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self._test_if_argumens_use_new_style(*args, **kwargs):
            ...
            try:
                ...
                del tb
            print(
                "DeprecationWarning: The Mesh and BaseMesh signature "
    ...
    def _test_if_argumens_use_new_style(self, *args, **kwargs):
        ...
        intDtypes = [np.uint8, np.uint16, np.uint32, np.int8, np.int16, np.int32]
    ...
    def _new_init(
        self, vertices=None, faces=None, normals=None, values=None, verticesPerFace=3
    ):
        # Return
    ...
    def SetColors(self, colors):
        ...
        """
        print(
            "DeprecationWarning: The SetColors() and SetTexcords() methods "
...
class Mesh(Wobject, BaseMesh, Colormapable):
    ...
    def faceShading():
        ...
        def fset(self, value):
            ...
            if value is None:
                ...
                value.lower() in ["plain", "flat", "gouraud", "smooth", "toon"]
            ):
    ...
    def edgeShading():
        ...
        def fset(self, value):
            ...
            if value is None:
                ...
                value.lower() in ["plain", "flat", "gouraud", "smooth"]
            ):
    ...
    def _SetShading(self, shading, shader):
        # Select shader part
        M = [
            (shaders.SH_MV_SHADING_PLAIN, shaders.SH_MF_SHADING_PLAIN),
    ...
    def _EnsureRightNumberOfLights(self, axes, shader):
        ...
        M = [
            shaders.SH_NLIGHTS_1,
            shaders.SH_NLIGHTS_2,
            shaders.SH_NLIGHTS_3,
            shaders.SH_NLIGHTS_4,
            shaders.SH_NLIGHTS_5,
            shaders.SH_NLIGHTS_6,
            shaders.SH_NLIGHTS_7,
            shaders.SH_NLIGHTS_8,
        ]
