...
from visvis.text.freetype.ft_enums import (
    FT_LOAD_RENDER,
    FT_LOAD_FORCE_AUTOHINT,  # noqa
    FT_KERNING_DEFAULT,
    FT_KERNING_UNFITTED,
)  # noqa
from visvis.text.freetype.ft_types import FT_Int
from visvis.text.freetype.ft_errors import FT_Exception
from visvis.text.freetype.ft_structs import (
    FT_Face,
    FT_Glyph,
    FT_Matrix,
    FT_Vector,  # noqa
...
class FreeTypeWrapper(object):
    ...
    def version(self):
        ...
        self._dll.FT_Library_Version(
            library, byref(amajor), byref(aminor), byref(apatch)
        )
